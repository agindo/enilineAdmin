    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <h3 style="margin-top:0px;margin-bottom:4px">{dataSubdiklat} <i class="fa fa-angle-double-right"></i> Angkatan</h3>
          </div>
          <div class="col-md-6">
          ...
          <div class="modal-content">
            ...
            <form id="form">
              ...
              <div class="form-group">
                ...
                <input type="hidden" class="form-control" name="id_subdiklat" value="{dataID}">
                <input type="text" class="form-control" name="angkatan_name" placeholder="Angkatan">
              </div>
              <div class="form-group">
